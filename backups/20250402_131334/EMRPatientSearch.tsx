...
import { useState, useEffect } from "react";// Definir la interfaz para la consulta de búsqueda
import { Button, Input, Select, Modal, Spinner } from "@chakra-ui/react";interface EMRSearchQuery {
  name: string;
  documentId: string;
  email: string;
  phone: string;
