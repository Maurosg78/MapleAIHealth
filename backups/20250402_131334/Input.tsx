...
import { useState, useEffect } from "react";export interface InputProps
import { Button, Input, Select, Modal, Spinner } from "@chakra-ui/react";  extends React.InputHTMLAttributes<HTMLInputElement> {
  label?: string;
  error?: string;
  helperText?: string;
