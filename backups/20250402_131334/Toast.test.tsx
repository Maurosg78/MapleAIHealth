...
import { render, screen } from "@testing-library/react";import { useState, useEffect } from "react";describe('Toast', () => {
import { Button, Input, Select, Modal, Spinner } from "@chakra-ui/react";  beforeEach(() => {
    vi.useFakeTimers();
  });
