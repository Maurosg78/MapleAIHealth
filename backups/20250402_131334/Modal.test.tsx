...
import { render, screen } from "@testing-library/react";import { useState, useEffect } from "react";describe('Modal', () => {
import { Button, Input, Select, Modal, Spinner } from "@chakra-ui/react";  const mockOnClose = vi.fn();
