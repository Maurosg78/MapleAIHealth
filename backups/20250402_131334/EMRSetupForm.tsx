...
import { useState, useEffect } from "react";// Definir interfaz para la configuración de EMR
import { Button, Input, Select, Modal, Spinner } from "@chakra-ui/react";interface EMRAdapterConfig {
  baseUrl?: string;
  username?: string;
  password?: string;
  apiUrl?: string;
