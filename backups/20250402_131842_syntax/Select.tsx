...
import { useState, useEffect } from "react";export interface SelectProps
import { Button, Input, Select, Modal, Spinner } from "@chakra-ui/react";  extends React.SelectHTMLAttributes<HTMLSelectElement> {
  label?: string;
  error?: string;
  helperText?: string;
  options: Array<{
