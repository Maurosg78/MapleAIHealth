...
import { useState, useEffect } from "react";export type AvatarSize = 'sm' | 'md' | 'lg' | 'xl';
import { Button, Input, Select, Modal, Spinner } from "@chakra-ui/react";export type AvatarVariant = 'circle' | 'square' | 'rounded';
