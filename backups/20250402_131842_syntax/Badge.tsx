...
import { useState, useEffect } from "react";export type BadgeType = 'success' | 'error' | 'warning' | 'info';
import { Button, Input, Select, Modal, Spinner } from "@chakra-ui/react";export type BadgeVariant = 'solid' | 'outlined' | 'ghost';
