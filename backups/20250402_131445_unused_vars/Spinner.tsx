...
import { useState, useEffect } from "react";export type SpinnerType = 'primary' | 'success' | 'error' | 'warning' | 'info';
import { Button, Input, Select, Modal, Spinner } from "@chakra-ui/react";export type SpinnerSize = 'sm' | 'md' | 'lg';
