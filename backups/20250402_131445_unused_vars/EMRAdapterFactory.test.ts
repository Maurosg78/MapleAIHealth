...
import { render, screen } from "@testing-library/react";// Creamos un mock de la clase Logger para evitar logs en los tests
import { HttpService } from "../../../lib/api";jest.mock('../../../lib/logger', () => {
  return {
