/**
import { render, screen } from "@testing-library/react"; * Datos mock para pruebas de adaptadores EMR
import { HttpService } from "../../../lib/api"; * Simula respuestas de APIs de sistemas EMR para pruebas unitarias
 */
