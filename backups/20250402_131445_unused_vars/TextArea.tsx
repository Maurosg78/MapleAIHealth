...
import { useState, useEffect } from "react";export interface TextAreaProps
import { Button, Input, Select, Modal, Spinner } from "@chakra-ui/react";  extends React.TextareaHTMLAttributes<HTMLTextAreaElement> {
  label?: string;
  error?: string;
  helperText?: string;
