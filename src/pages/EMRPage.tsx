...
export const EMRPage: React.FC = () => {
    ...
    const [activeTab, setActiveTab] = useState<'info' | 'history' | 'labs' | 'ai'>('info');
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                ...
                                />
                                <div>
                                    <div id="allergies-label" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                        Alergias
                                    </div>
                                    <ul
                                ...
                                <div>
                                    <div id="medications-label" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
