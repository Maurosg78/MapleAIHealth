...
import { UnstructuredNote, AIResponse, aiService } from '../services/ai/aiService';
...
export const TestAIPage: React.FC = () => {
    ...
    const handleNoteSubmit = async (note: UnstructuredNote) => {
        try {
            ...
            const results = await aiService.analyzeUnstructuredNotes('test-patient', notesForAnalysis);
            setAnalysis(results);
        } catch (err) {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <h1 className="text-2xl font-bold mb-8">Prueba del Asistente Virtual Médico</h1>
