...
describe('Spinner', () => {
    ...
    it('aplica los estilos correctos según el tipo', () => {
        ...
        expect(screen.getByRole('status').querySelector('svg')).toHaveClass('text-green-600');
        ...
        expect(screen.getByRole('status').querySelector('svg')).toHaveClass('text-yellow-600');
