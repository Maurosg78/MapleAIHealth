...
export const Alert: React.FC<AlertProps> = ({
    ...
    return (
        <output className={cn(baseStyles, variantStyles[variant][type], className)} role="alert">
            {icon || (Icon && <Icon className={cn('h-5 w-5', iconColorStyles[type])} aria-hidden="true" />)}
