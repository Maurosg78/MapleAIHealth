...
const EvidenceViewerDemo: React.FC = () => {
  ...
  const [evaluationResult, setEvaluationResult] =
    useState<EvidenceEvaluationResult | null>(null);
  ...
  useEffect(() => {
    ...
    null
      ...
      // Si el servicio real falla, usar datos simulados
          logger.debug('Usando datos simulados para la demo');
  ...
  const handleExampleClick = (
    example: 'hypertension' | 'diabetes' | 'arthritis'
  ) => {
    ...
    React.createElement('div', { className: "space-y-6" }, 
      <Card className="p-4">
        <h2 className="text-xl font-bold mb-4">
          Visualizador de Evidencia Clínica
        </h2>
        <p className="text-gray-600 mb-4">
          Este componente permite visualizar la evaluación de evidencia clínica
          y recomendaciones médicas basadas en evidencia.
        </p>
        ...
        <div className="flex flex-wrap gap-2 mt-4">
          <Button
            ...
            className={
              selectedExample === 'hypertension' ? 'bg-blue-500 text-white' : ''
            }
          >
            Hipertensión
          </Button>
          <Button
            ...
            className={
              selectedExample === 'diabetes' ? 'bg-blue-500 text-white' : ''
            }
          >
            Diabetes
          </Button>
          <Button
            ...
            className={
              selectedExample === 'arthritis' ? 'bg-blue-500 text-white' : ''
            }
          >
            Artritis
          </Button>
...
const getSimulatedEvaluationResult = (
  example: string
): EvidenceEvaluationResult => {
  const results: Record<string, EvidenceEvaluationResult> = {
    hypertension: {
      ...
      details: {
        level: 'A',
        description:
          'Evidencia de alta calidad basada en múltiples ensayos clínicos controlados con placebo',
        criteria:
          'Evidencia basada en al menos 2 ensayos clínicos de alta calidad metodológica publicados en revistas con revisión por pares',
        reliability: 'high',
        sources: [
          {
            id: 'pmid-12345678',
            title:
              'Efficacy of ACE inhibitors in essential hypertension: a meta-analysis of randomized controlled trials',
          ...
          },
          {
            id: 'pmid-87654321',
            title:
              'Long-term effects of enalapril on cardiovascular mortality and morbidity in patients with hypertension',
      ...
      confidenceScore: 92,
      limitationsNotes:
        'La mayoría de estudios no incluyeron pacientes con comorbilidades graves, por lo que los resultados podrían no ser generalizables a esta población',
      suggestedAlternatives: [
        'Para pacientes con intolerancia a IECA, considerar bloqueadores de receptores de angiotensina (ARA-II)',
    ...
    diabetes: {
      ...
      details: {
        level: 'B',
        description:
          'Evidencia de calidad moderada basada en estudios observacionales y ensayos clínicos limitados',
        criteria:
          'Evidencia basada en estudios observacionales bien diseñados y ensayos clínicos con limitaciones metodológicas',
        reliability: 'moderate',
        sources: [
          {
            id: 'pmid-23456789',
            title:
              'Metformin as first-line therapy in type 2 diabetes: a systematic review',
          ...
          },
          {
            id: 'pmid-34567890',
            title:
              'Cardiovascular outcomes in patients with type 2 diabetes treated with metformin',
      ...
      confidenceScore: 78,
      limitationsNotes:
        'Faltan ensayos clínicos aleatorizados a largo plazo que evalúen específicamente los desenlaces cardiovasculares',
      suggestedAlternatives: [
    ...
    arthritis: {
      ...
      details: {
        level: 'D',
        description:
          'Evidencia insuficiente y de baja calidad con resultados contradictorios',
        criteria:
          'Estudios con serias limitaciones metodológicas, evidencia contradictoria o ausencia de ensayos clínicos adecuados',
        reliability: 'low',
        sources: [
          {
            id: 'pmid-45678901',
            title:
              'Effects of glucosamine supplements on osteoarthritis: a case series',
      ...
      confidenceScore: 35,
      limitationsNotes:
        'Estudios existentes muestran resultados inconsistentes. Faltan ensayos clínicos bien diseñados con metodología estandarizada.',
      suggestedAlternatives: [
    ...
    hypertension: [
      {
        ...
        description:
          'Iniciar enalapril 5mg una vez al día, aumentando gradualmente hasta 20mg diarios según respuesta y tolerancia.',
        priority: 'high',
        timeframe: 'Iniciar en la próxima visita',
        rationale:
          'Los IECA han demostrado eficacia en la reducción de la presión arterial y mortalidad cardiovascular en pacientes con hipertensión esencial.',
        evidenceLevel: 'A',
      },
      {
        type: 'lifestyle',
        ...
        description:
          'Implementar dieta DASH (Dietary Approaches to Stop Hypertension) rica en frutas, verduras y lácteos bajos en grasa.',
        priority: 'medium',
        timeframe: 'Iniciar inmediatamente y mantener a largo plazo',
        rationale:
          'La dieta DASH ha demostrado reducir la presión arterial en aproximadamente 8-14 mmHg sistólica.',
        evidenceLevel: 'B',
      },
      {
        type: 'follow-up',
        ...
        description:
          'Realizar mediciones domiciliarias de presión arterial dos veces al día y llevar registro para evaluación médica.',
        priority: 'medium',
        timeframe: 'Diariamente',
        rationale:
          'El monitoreo frecuente permite ajustes terapéuticos oportunos y mejora el control a largo plazo.',
        evidenceLevel: 'B',
      },
    ],
    diabetes: [
      {
        ...
        description:
          'Comenzar con metformina 500mg/día con las comidas, aumentando gradualmente a 1000mg dos veces al día después de 1-2 semanas si es bien tolerada.',
        priority: 'high',
        timeframe: 'Iniciar en la próxima visita',
        rationale:
          'La metformina reduce efectivamente los niveles de glucosa sanguínea, particularmente la producción hepática de glucosa, y puede proporcionar beneficios cardiovasculares adicionales.',
        evidenceLevel: 'B',
      },
      {
        type: 'lifestyle',
        ...
        description:
          'Implementar plan de alimentación individualizado con restricción calórica moderada, bajo contenido de carbohidratos simples y alto contenido de fibra.',
        priority: 'high',
        timeframe: 'Iniciar inmediatamente',
        rationale:
          'La modificación dietética puede reducir la HbA1c en aproximadamente 1-2% y mejorar la sensibilidad a la insulina.',
        evidenceLevel: 'B',
      },
      {
        type: 'test',
        ...
        description:
          'Realizar prueba de hemoglobina glicosilada cada 3 meses hasta alcanzar objetivo terapéutico.',
        priority: 'medium',
        timeframe: 'Cada 3 meses',
        rationale:
          'El monitoreo regular permite evaluar la eficacia del tratamiento y realizar ajustes oportunos.',
        evidenceLevel: 'B',
      },
    ],
    arthritis: [
      {
        ...
        description:
          'Considerar suplemento de glucosamina sulfato 1500mg/día vía oral.',
        priority: 'low',
        timeframe: 'Opcional',
        rationale:
          'Algunos estudios sugieren que la glucosamina puede proporcionar alivio sintomático del dolor articular en osteoartritis, pero la evidencia es contradictoria.',
        evidenceLevel: 'D',
      },
      {
        type: 'medication',
        ...
        description:
          'Iniciar paracetamol 500mg cada 8 horas según necesidad para dolor.',
        priority: 'medium',
        timeframe: 'Según necesidad',
        rationale:
          'El paracetamol es un analgésico con perfil de seguridad favorable y eficacia moderada para el dolor de osteoartritis.',
        evidenceLevel: 'B',
      },
      {
        type: 'consultation',
        ...
        description:
          'Derivar a fisioterapia para programa de ejercicios específicos y terapia manual.',
        priority: 'high',
        timeframe: 'Próximas 2 semanas',
        rationale:
          'Los programas de ejercicio estructurado han demostrado reducir el dolor y mejorar la función articular en pacientes con osteoartritis.',
        evidenceLevel: 'A',
      },
    ],
  };
