...
export const PatientForm: React.FC<PatientFormProps> = ({ patient, onSubmit, isLoading }) => {
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <Input
                            label="País"
                            {...register('address.country', { required: 'El país es requerido' })}
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <Input
                            label="Nombre"
                            {...register('emergencyContact.name', { required: 'El nombre es requerido' })}
                    ...
                    <div>
                        <Input
                            label="Teléfono"
                            {...register('emergencyContact.phone', { required: 'El teléfono es requerido' })}
