...
export const AppointmentFormModal: React.FC<AppointmentFormModalProps> = ({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (appointment) {
                ...
                await appointmentService.createAppointment(formData as Omit<Appointment, 'id' | 'createdAt' | 'updatedAt'>);
            }
            onSuccess();
            onClose();
        } catch (err) {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title={appointment ? 'Editar Cita' : 'Nueva Cita'}>
